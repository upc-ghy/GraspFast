...
if __name__ == '__main__':
    ...
    idx = cfgs.idx
    save_path_root = os.path.join(dataset_root, 'GraspFast')

    num_directions, num_angles, num_depths = 300, 12, 4
    fric_coef_thresh = 0.8
    point_grasp_num = num_directions * num_angles * num_depths
    for scene_id in range(100):
        ...
        for ann_id in range(256):
            ...
            for i, (obj_idx, trans_) in enumerate(zip(obj_list, pose_list)):
                ...
                collision = collision_dump[i]  # Npoints * num_directions * num_angles * num_depths
            ...
            for i in range(1, part_num + 2):
                ...
                nn_inds = myknn(grasp_points, cloud_masked_partial, k=1).squeeze() - 1
